...
This is a DSP platform ([website](https://www.shure.com/en-US/products/mixers/dfr22?variant=DFR22)) that we used to use to run audio processing on the Mains signal. It was configured as the pre-EQ insert on the main LR as an offboard insert (send on Allen & Heath AR84 output channel 3 & 4, insert return on board input 43 & 44). It is no longer used and should be removed.
